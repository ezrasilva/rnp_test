...
class TelemetryServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.StreamTelemetry = channel.stream_unary(
                '/pqc.telemetry.TelemetryService/StreamTelemetry',
...
def add_TelemetryServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pqc.telemetry.TelemetryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pqc.telemetry.TelemetryService', rpc_method_handlers)
